...
def sampling_li_l(population: list[Any], weights: list[float], sample_size: int) -> Iterable[Any]:
    return rsx.reservoir.li_l.li_l_sampling(population, sample_size)
